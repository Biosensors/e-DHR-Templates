USE [BpmTemplate]
GO
/****** Object:  StoredProcedure [dbo].[DHR_get_chemical_check_summary_for_prod_confirmation_by_order_no]    Script Date: 31/8/2023 5:05:25 pm ******/
SET ANSI_NULLS ON
GO
...
-- Description:	get chemical check summary data for production DHR template
-- =============================================
ALTER PROCEDURE [dbo].[DHR_get_chemical_check_summary_for_prod_confirmation_by_order_no]
...
from (
		...
		as pivotTable
		order by [Original Completion Date],[Chemical],[station]
END
